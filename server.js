...
const PREMIUM_RAFFLE_RULES_URL =
  process.env.PREMIUM_RAFFLE_RULES_URL || "https://dfdkfdlfk.ru";
...
function buildPremiumRaffleSuccessLines(raffleTicket) {
  ...
  return [
    ...
    `Участвуйте в [акции](${PREMIUM_RAFFLE_RULES_URL}) с розыгрышем призов.`,
  ...
  if (["stats", "stat", "стат"].includes(parsed.action)) {
    ...
    await sendMaxMessage(
      ...
      [
        ...
        "",
        `Правила: [акция](${PREMIUM_RAFFLE_RULES_URL})`
      ].join("\n")
    );
