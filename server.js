...
async function sendCreatePromptVideoHelp(target, userId) {
  ...
  if (videoAccess.allowed) {
    ...
    return sendMaxMessageWithAttachments(
      ...
      [
        ...
        "",
        "Видео будет создано на **5 секунд**, качество **480p**, модель **Seedance Lite**.",
        "",
        "Пример:",
  ...
  let text =
    ...
    "Параметры: **5 секунд**, качество **480p**, модель **Seedance Lite**.\n\n" +
...
async function handlePromptVideoRequest(update, target, userText, incomingImageUrl, userId = target.id) {
  ...
  await sendMaxVideo(
    ...
    [
      ...
      "",
      "Видео создано на **5 секунд**, качество **480p**, модель **Seedance Lite**.",
      "",
      inputImage
